...
const PlanController = () => {
  return (
    <form className="pb-12 border-b">
      <RangeInput />
      <div className="md:hidden mt-10"><TotalPrice /></div>
      <div className="mt-14 gap-5 flex flex-wrap justify-center items-center">
        <h5 className="text-grayish-blue font-semibold max-md:text-sm">Monthly Billing</h5>
        <BillSwitcher />
        <div className="flex gap-3 items-center flex-wrap">
          <h5 className="text-grayish-blue font-semibold max-md:text-sm">Yearly Billing</h5>
